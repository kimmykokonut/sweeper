      ...
      <div className="w-full max-w-sm sm:max-w-md my-auto flex flex-col items-center py-2">
        ...
        <div className="grid grid-cols-2 gap-3.5 sm:gap-5 w-full">
          ...
          >
            ...
            />
            <div className="mt-2.5 w-full min-h-[48px] rounded-xl bg-yellow-400 group-hover:bg-yellow-300 text-emerald-950 p-2 sm:p-2.5 text-center transition-all shadow-md flex flex-col items-center justify-center">
